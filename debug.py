    ...
    try:
        while True:
            ...
            # >> mode 2: calibrate sensors (down button)
                ...
                print("[ROBOT] Start: Calibrating (5s)...")
                ...
                print("\n" + "="*40)
                print(f">>> BLACK_LIGHT = {mn}")
                print(f">>> WHITE_LIGHT = {mx}")
                print("please update BLACK_LIGHT and WHITE_LIGHT")
                print("in config.py with the values above.")
                print("="*40 + "\n")
